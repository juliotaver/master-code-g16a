...
let htmlInicio = '<button onclick="login()">Iniciar sesión</button> <button onclick="crearCuenta()">Crear cuenta</button>';
// Consultar/Ingresar/Retirar/Salir
let htmlOperaciones = '<p>Elija la operación a realizar:</p><button onclick="consultarDisponible()">Consultar saldo</button> <button onclick="ingresar()">Ingresar monto</button> <button onclick="retirar()">Retirar monto</button> <button onclick="salir()">Salir</button>';
// Resultado / Volver
let htmlRespuesta = '<p id="texto"></p><button onclick="operaciones()">Volver</button>';
// 
